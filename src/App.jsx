    ...
    <>
      <main>
        <div className="images">
          ...
          <img id='Lourise' src="\Lourise.png" alt="" />
          <img id='KIKKFestival' src="\KIKK Festival.png" alt="" />
        ...
        <section id='section-1'>
          ...
          <div className="middle">
            <div className="left">
              <h1>WE <br></br> Make <br></br> Good <br></br> Shit</h1>
            </div>
